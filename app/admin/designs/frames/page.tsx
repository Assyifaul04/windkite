...
const statusConfig = {
  ...
  PUBLISHED: { label: 'Published', color: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' },
  ARCHIVED: { label: 'Archived', color: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' },
};
                ...
                <TableRow>
                  <TableCell colSpan={7} className="text-center py-8 text-muted-foreground">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p>No frames found</p>
                      <p className="text-sm">Create a new frame to get started</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : (
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              and remove it from all designs.
              {selectedFrame && (
